...
export const CreateUserSchema = UserSchema.omit({ _id: true, createdAt: true, updatedAt: true, lastLogin: true }).extend({
...
export const StudentSchema = z.object({
  ...
  transportId: ObjectIdSchema.optional(),
...
export const TeacherSchema = z.object({
  ...
  classTeacherOf: z.array(ObjectIdSchema).default([]),
  documents: z.array(z.object({
    type: z.nativeEnum(DocumentType),
    url: z.string().url(),
    uploadedAt: z.string().datetime()
...
export const ClassSchema = z.object({
  ...
  sectionIds: z.array(ObjectIdSchema).default([]),
...
export const PaymentSchema = z.object({
  ...
  receiptNo: z.string().max(20),
  collectedBy: ObjectIdSchema,
  date: z.string().datetime(),
  createdAt: z.string().datetime().optional()
});
