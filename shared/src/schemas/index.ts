...
export const SectionSchema = z.object({ _id: ObjectIdSchema.optional(), name: z.string().max(10), classId: ObjectIdSchema, capacity: z.number().int().positive().default(40), createdAt: z.string().datetime().optional() });
