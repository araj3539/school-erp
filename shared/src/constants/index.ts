...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  ...
  [UserRole.TEACHER]: ["attendance:read", "attendance:write", "homework:read", "homework:write", "marks:read", "marks:write", "exams:read", "students:read", "notices:read", "timetable:read:own"],
