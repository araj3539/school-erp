...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  ...
  [UserRole.ACCOUNTANT]: ["fees:read", "fees:write", "payments:read", "payments:write", "payments:reverse", "expenses:read", "expenses:write", "salary:read", "salary:write", "reports:read", "reports:export", "notices:read", "timetable:read"],
