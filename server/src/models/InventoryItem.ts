...
export interface IInventoryItem extends Document{schoolId:Types.ObjectId;itemCode:string;name:string;category?:string;unit:string;quantity:number;reorderLevel:number;status:(typeof InventoryItemStatus)[keyof typeof InventoryItemStatus];createdAt:Date;updatedAt:Date}
