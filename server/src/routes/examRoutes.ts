...
import { getExams, getExamById, createExam, updateExam, publishExam, upsertMarks, correctResult, getResults, getResultById, downloadReportCard } from "../controllers/examController.js";
