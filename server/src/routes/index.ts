...
import classGovernanceRoutes from "./classGovernanceRoutes.js";
...
const router = Router();
router.use("/auth", authRoutes); router.use("/modules", moduleEntitlementRoutes);
...
router.use("/students/governance", authenticate, requireModule("students"), classGovernanceRoutes);
router.use("/teachers", authenticate, requireModule("teachers"), teacherRoutes); router.use("/staff", authenticate, requireModule("staff"), staffRoutes);
router.use("/library", authenticate, requireModule("library"), libraryRoutes); router.use("/transport", authenticate, requireModule("transport"), transportRoutes); router.use("/inventory", authenticate, requireModule("inventory"), inventoryRoutes);
