...
router.post("/structures", requirePermission("fees:write"), validate(CreateFlexibleFeeStructureSchema), createFeeStructure);
router.put("/structures/:id", requirePermission("fees:write"), validate(IdParamSchema, "params"), validate(UpdateFlexibleFeeStructureSchema), updateFeeStructure);
