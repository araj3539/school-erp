...
import { CalendarEventSchema, CalendarQuerySchema } from "../validators/academicCalendar.js";
...
router.patch("/:id", requirePermission("school:update"), validate(IdParamSchema, "params"), validate(CalendarEventSchema.partial()), updateCalendarEvent);
