...
import { CreateStudentSchema, UpdateStudentSchema, PaginationSchema, StudentQuerySchema, IdParamSchema, StudentDocumentParamSchema, StudentDocumentRecoveryParamSchema, DocumentRecoveryHistoryQuerySchema } from "../validators/index.js";
const router = Router();
