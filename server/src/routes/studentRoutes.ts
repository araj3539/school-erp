...
import { CreateStudentSchema, UpdateStudentSchema, PaginationSchema, StudentQuerySchema, IdParamSchema, StudentDocumentParamSchema, StudentDocumentRecoveryParamSchema } from "../validators/index.js";
const router = Router();
