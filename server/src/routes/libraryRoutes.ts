...
import { getBooks, getBookById, createBook, updateBook, getCopies, createCopy, updateCopy, getLoans, issueLoan, returnLoan } from "../controllers/libraryController.js";
...
router.delete("/books/:id", requirePermission("library:delete"), validate(IdParamSchema, "params"), validate(UpdateLibraryBookSchema), updateBook);
