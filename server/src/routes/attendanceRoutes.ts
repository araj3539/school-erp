...
router.get("/student/:id", requireAnyPermission("attendance:read", "attendance:read:own", "attendance:read:child"), validate(IdParamSchema, "params"), validate(DateRangeSchema, "query"), getStudentAttendance);
