...
export default function PortalFeesPage() {
  ...
  const students = data?.students || []; const selectedStudentId = data?.selectedStudentId || childId || students[0]?._id || ""; const student = students.find((item: any) => item._id === selectedStudentId) || students[0]; const fees = data?.fees || []; const summary = data?.summary || { totalDue: 0, paid: 0, balance: 0, overdue: 0 };
